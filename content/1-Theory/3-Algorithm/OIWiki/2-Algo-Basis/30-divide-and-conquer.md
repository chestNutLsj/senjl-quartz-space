...
1.  [什么是递归？](30-divide-and-conquer.md)
...
![[30-divide-and-conquer-nonrecursion-vs-recursion.png]]
...
>[!warning] 
>如果各子问题是不独立的，则分治法要重复地解公共的子问题，也就做了许多不必要的工作。此时虽然也可用分治法，但一般用 [[13-Dynamic-Programming]] 较好。
