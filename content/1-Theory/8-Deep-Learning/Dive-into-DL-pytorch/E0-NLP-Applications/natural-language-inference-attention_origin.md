...
![This section feeds pretrained GloVe to an architecture based on attention and MLPs for natural language inference.](nlp-map-nli-attention.svg)
...
![Natural language inference using attention mechanisms.](nli-attention.svg)
