...
![Identify a wake word.](wake-word.svg)
:label:`fig_wake_word`
...
![A typical training process.](ml-loop.svg)
:label:`fig_ml_loop`
...
![Death cap---do not eat!](death-cap.jpg)
:width:`200px`
:label:`fig_death_cap`
...
![A donkey, a dog, a cat, and a rooster.](stackedanimals.png)
:width:`300px`
...
![Deep learning books recommended by Amazon.](deeplearning-amazon.jpg)
...
![`-D-e-e-p- L-ea-r-ni-ng-` in an audio recording.](speech.png)
:width:`700px`
:label:`fig_speech`
...
![Collecting data for supervised learning from an environment.](data-collection.svg)
...
![The interaction between reinforcement learning and an environment.](rl-environment.svg)
...
![Estimating the length of a foot.](koebel.jpg)
:width:`500px`
:label:`fig_koebel`
