...
![The main difference between ResNet (left) and DenseNet (right) in cross-layer connections: use of addition and use of concatenation. ](densenet-block.svg)
...
![Dense connections in DenseNet.](densenet.svg)
:label:`fig_densenet`
