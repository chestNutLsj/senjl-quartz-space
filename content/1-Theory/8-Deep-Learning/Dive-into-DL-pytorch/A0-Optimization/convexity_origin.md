...
![The first set is nonconvex and the other two are convex.](pacman.svg)
:label:`fig_pacman`
...
![The intersection between two convex sets is convex.](convex-intersect.svg)
...
![The union of two convex sets need not be convex.](nonconvex.svg)
:label:`fig_nonconvex`
