...
![Latency Numbers that every programmer should know.](latencynumbers.png)
...
![Connectivity of components of a computer.](mobo-symbol.svg)
...
![Intel Skylake consumer quad-core CPU.](skylake.svg)
:label:`fig_skylake`
...
![ARM Cortex A77 Microarchitecture.](a77.svg)
:label:`fig_cortexa77`
...
![128 bit NEON vectorization.](neon128.svg)
:label:`fig_neon128`
...
![False sharing (image courtesy of Intel).](falsesharing.svg)
...
![NVIDIA Turing processing block (image courtesy of NVIDIA).](turing-processing-block.png)
:width:`150px`
...
![NVIDIA Turing architecture (image courtesy of NVIDIA)](turing.png)
:width:`350px`
:label:`fig_turing`
...
![NVIDIA tensor cores in Turing (image courtesy of NVIDIA).](tensorcore.jpg)
:width:`400px`
