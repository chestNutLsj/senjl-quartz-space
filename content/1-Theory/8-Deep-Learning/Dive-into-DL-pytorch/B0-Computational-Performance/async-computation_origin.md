...
![Programming language frontends and deep learning framework backends.](frontends.png)
:width:`300px`
:label:`fig_frontends`
...
![The backend tracks dependencies between various steps in the computational graph.](asyncgraph.svg)
...
![Interactions of the frontend and backend.](threading.svg)
:label:`fig_threading`
