...
![Two-dimensional cross-correlation with padding.](conv-pad.svg)
:label:`img_conv_pad`
...
![Cross-correlation with strides of 3 and 2 for height and width, respectively.](conv-stride.svg)
