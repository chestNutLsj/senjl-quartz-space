...
![Data flow in LeNet. The input is a handwritten digit, the output a probability over 10 possible outcomes.](60-lenet-construction.svg)
:label:`img_lenet`
...
![Compressed notation for LeNet-5.](lenet-vert.svg)
