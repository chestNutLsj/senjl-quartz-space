...
![An RNN with a hidden state.](rnn.svg)
:label:`fig_rnn`
...
![A character-level language model based on the RNN. The input and label sequences are "machin" and "achine", respectively.](rnn-train.svg)
:label:`fig_rnn_train`
