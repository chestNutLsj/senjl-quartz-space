...
![Training data for distinguishing cats and dogs.](cat-dog-train.svg)
:label:`fig_cat-dog-train`


At test time we are asked to classify the images in :numref:`fig_cat-dog-test`.

![Test data for distinguishing cats and dogs.](cat-dog-test.svg)
...
![Concept shift on soft drink names in the United States.](popvssoda.png)
:width:`400px`
:label:`fig_popvssoda`
