...
![Sequence to sequence learning with an RNN encoder and an RNN decoder.](seq2seq.svg)
:label:`fig_seq2seq`
...
![Layers in an RNN encoder-decoder model.](seq2seq-details.svg)
...
![Predicting the output sequence token by token using an RNN encoder-decoder.](seq2seq-predict.svg)
