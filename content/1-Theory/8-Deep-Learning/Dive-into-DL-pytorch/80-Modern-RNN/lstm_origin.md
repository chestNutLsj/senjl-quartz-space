...
![Computing the input gate, the forget gate, and the output gate in an LSTM model.](lstm-0.svg)
:label:`lstm_0`
...
![Computing the candidate memory cell in an LSTM model.](lstm-1.svg)
:label:`lstm_1`
...
![Computing the memory cell in an LSTM model.](lstm-2.svg)
...
![Computing the hidden state in an LSTM model.](lstm-3.svg)
:label:`lstm_3`
