...
![IoU is the ratio of the intersection area to the union area of two bounding boxes.](iou.svg)
:label:`fig_iou`
...
![Assigning ground-truth bounding boxes to anchor boxes.](anchor-label.svg)
