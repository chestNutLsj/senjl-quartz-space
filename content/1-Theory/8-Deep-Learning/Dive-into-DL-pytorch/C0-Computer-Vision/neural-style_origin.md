...
![Given content and style images, style transfer outputs a synthesized image.](style-transfer.svg)
...
![CNN-based style transfer process. Solid lines show the direction of forward propagation and dotted lines show backward propagation. ](neural-style.svg)
