...
![The fast R-CNN model.](fast-rcnn.svg)
...
![A $2\times 2$ region of interest pooling layer.](roi.svg)
:label:`fig_roi`
...
![The faster R-CNN model.](faster-rcnn.svg)
...
![The mask R-CNN model.](mask-rcnn.svg)
