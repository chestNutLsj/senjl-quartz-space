...
> 1. 他们看起来像是在构建或安装时被评估的，但实际上他们只对每个构建中的配置进行评估。 [↩](https://modern-cmake-cn.github.io/Modern-CMake-zh_CN/chapters/basics/functions.html#reffn_1 "Jump back to footnote [1] in the text.")
