...
date: "2025-12-29T18:09:20+08:00"
description: "We’re on a journey to advance and democratize artificial intelligence through open source and open science."
tags:
  - "clippings"
---
> 本文截取自互联网博客并做一定修改：https://huggingface.co/blog/moe
...
[lewtun](https://huggingface.co/lewtun)
...
[Philipp Schmid](https://huggingface.co/philschmid)

[philschmid](https://huggingface.co/philschmid)

![Sourab Mangrulkar's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1638132956881-5fca176d1d7a08cb34d79d5d.jpeg)

Sourab Mangrulkar's avatar

[Sourab Mangrulkar](https://huggingface.co/smangrul)
...
[Younes B](https://huggingface.co/ybelkada)

[ybelkada](https://huggingface.co/ybelkada)
...
- [What is a Mixture of Experts?](https://huggingface.co/blog/#what-is-a-mixture-of-experts-moe)
- [A Brief History of MoEs](https://huggingface.co/blog/#a-brief-history-of-moes)
- [What is Sparsity?](https://huggingface.co/blog/#what-is-sparsity)
- [Load Balancing tokens for MoEs](https://huggingface.co/blog/#load-balancing-tokens-for-moes)
- [MoEs and Transformers](https://huggingface.co/blog/#moes-and-transformers)
- [Switch Transformers](https://huggingface.co/blog/#switch-transformers)
- [Stabilizing training with router Z-loss](https://huggingface.co/blog/#stabilizing-training-with-router-z-loss)
- [What does an expert learn?](https://huggingface.co/blog/#what-does-an-expert-learn)
- [How does scaling the number of experts impact pretraining?](https://huggingface.co/blog/#how-does-scaling-the-number-of-experts-impact-pretraining)
- [Fine-tuning MoEs](https://huggingface.co/blog/#fine-tuning-moes)
- [When to use sparse MoEs vs dense models?](https://huggingface.co/blog/#when-to-use-sparse-moes-vs-dense-models)
- [Making MoEs go brrr](https://huggingface.co/blog/#making-moes-go-brrr)
	- [Expert Parallelism](https://huggingface.co/blog/#parallelism)
	- [Capacity Factor and Communication costs](https://huggingface.co/blog/#capacity-factor-and-communication-costs)
	- [Serving Techniques](https://huggingface.co/blog/#serving-techniques)
	- [Efficient Training](https://huggingface.co/blog/#more-on-efficient-training)
- [Open Source MoEs](https://huggingface.co/blog/#open-source-moes)
- [Exciting directions of work](https://huggingface.co/blog/#exciting-directions-of-work)
- [Some resources](https://huggingface.co/blog/#some-resources)
...
GShard replaces every other FFN layer with an MoE layer using top-2 gating in both the encoder and the decoder. The next image shows how this looks like for the encoder part. This setup is quite beneficial for large-scale computing: when we scale to multiple devices, the MoE layer is shared across devices while all the other layers are replicated. This is further discussed in the [“Making MoEs go brrr”](https://huggingface.co/blog/#making-moes-go-brrr) section.
...
This [notebook](https://colab.research.google.com/drive/1aGGVHZmtKmcNBbAwa9hbu58DDpIuB5O4?usp=sharing) showcases fine-tuning Switch Transformers for summarization, but we suggest first reviewing the [fine-tuning section](https://huggingface.co/blog/#fine-tuning-moes).
...
[![](https://huggingface.co/blog/assets/intel-qwen3-agent/smolagents-1300-650.png)](https://huggingface.co/blog/intel-qwen3-agent)

[llm intel nlp](https://huggingface.co/blog/intel-qwen3-agent)
...
[View original](https://huggingface.co/blog/intel-qwen3-agent)

[![](https://huggingface.co/blog/assets/cosmopedia/thumbnail.png)](https://huggingface.co/blog/cosmopedia)

[guide nlp synthetic-data](https://huggingface.co/blog/cosmopedia)
...
[View original](https://huggingface.co/blog/cosmopedia)
