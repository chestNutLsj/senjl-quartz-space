...
![For non-nested function classes, a larger (indicated by area) function class does not guarantee to get closer to the "truth" function ($f^*$). This does not happen in nested function classes.](functionclasses.svg)
...
![The ResNet-18 architecture.](resnet18.svg)
:label:`fig_resnet18`
