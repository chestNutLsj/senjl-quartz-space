...
> 符号化 AI 的关键点就是知识，并且 **知识** 与 **数据/信息** 的差异有必要仔细区分。例如，一个人可以说书本中含有知识，因为人们可以从中学习到知识并成为专家。但实际上书本中包含的是数据，通过读书并吸收这些数据，我们可以转化为知识。
...
> 因此，知识表达这个问题就是找到一些有效的方法在计算机中利用数据表达知识，使得其可以自动使用。例如下面的光谱：

![[knowledge-spectrum.png]]
...
![Human Architecture](arch-human.png) | ![Knowledge-Based System](arch-kbs.png)
---------------------------------------------|------------------------------------------------
...
**Assignment**: [Build an Ontology](1-Theory/8-Deep-Learning/AI-for-Beginners-MS/2-Symbolic/assignment.md)
